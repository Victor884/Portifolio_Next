    ...
    <section className="w-full lg:h-[755px] bg-hero-image bg-cover bg-center bg-no-repeat flex flex-col justify-end pb-10 sm:pb-32 lg:pb-[110px]"> 
        <div className="container flex items-center justify-between flex-col-reverse lg:flex-row pt-32">
            <div className="w-full lg:max-w-[530px]">
                <p className="text-emerald-400 font-mono">Hello, I'm João Victor</p>
                <h2 className="text-4xl font-medium mt-2">I'm a software engineer</h2>
                <p className="text-gray-400 my-6 text-sm sm:text-base">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Saepe atque est molestias dolore explicabo. Odio, dolor eius obcaecati inventore ipsam ut ex saepe nostrum rerum enim odit aliquid. Ut, dolore!</p>
